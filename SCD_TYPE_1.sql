DROP TABLE IF EXISTS dim_customers_scd_type_1;

CREATE TABLE IF NOT EXISTS dim_customers_scd_type_1(
...
INSERT INTO dim_customers_scd_type_1(customer_id, first_name, last_name, phone, email)
VALUES
...
DROP TABLE IF EXISTS staging_customers_scd_type_1;

CREATE TABLE IF NOT EXISTS staging_customers_scd_type_1(
    row_id INT AUTOINCREMENT PRIMARY KEY,
    customer_id INT UNIQUE,
    first_name VARCHAR(50),
    last_name VARCHAR(50),
...
INSERT INTO staging_customers_scd_type_1(customer_id, first_name, last_name, phone, email)
VALUES
...
MERGE INTO dim_customers_scd_type_1 AS target
USING staging_customers_scd_type_1 AS source
